...
function WhatsAppButton({ message }: { message: string }) {
  ...
  return (
    <a
      ...
      className="flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-lg bg-green-600 hover:bg-green-700 text-gray-900 dark:text-white text-sm font-medium transition-colors cursor-pointer"
    >
        ...
        <div className="rounded-2xl p-6 shadow-xl shadow-black/5 dark:shadow-black/40 bg-white dark:bg-[rgba(12,12,20,0.85)]" style={{ border: '1px solid rgba(16,185,129,0.1)' }}>
          ...
          {tab === 'login' ? (
            ...
            <div className="text-center py-4">
              ...
              <h3 className="text-gray-900 dark:text-white font-semibold text-lg mb-2">Cadastro realizado!</h3>
