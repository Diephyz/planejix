...
function renderCell(value: boolean | string) {
  ...
  return <span className="text-xs font-bold text-brand-400 bg-brand-500/15 px-2 py-0.5 rounded-full">{value}</span>;
}
    ...
    <div className="max-w-3xl mx-auto space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          ...
          {!isPro && (
            <div className="text-center text-xs text-brand-400 font-semibold bg-brand-500/10 rounded-xl py-2.5">
              Plano atual
            </div>
          )}
        </div>
        ...
        >
          ...
          <div className="relative">
            <div className="absolute -top-1 -right-1">
              <span className="bg-gradient-to-r from-brand-500 to-purple-500 text-white text-[10px] font-bold px-2.5 py-1 rounded-full shadow-lg shadow-brand-500/25">
                POPULAR
              </span>
            </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          ...
          <div key={item.title} className="rounded-xl p-4 text-center" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.04)' }}>
