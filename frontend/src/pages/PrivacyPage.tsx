    ...
    <div className="max-w-3xl mx-auto space-y-6 pb-20 lg:pb-0 animate-fade-in">
      ...
      <div className="card space-y-5 text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        <section>
          ...
          <p className="mt-2 text-gray-500 dark:text-gray-400">Nós <strong className="text-gray-900 dark:text-white">nunca</strong> vendemos, compartilhamos ou cedemos seus dados pessoais ou financeiros a terceiros.</p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2 text-gray-500 dark:text-gray-400">Para exercer qualquer desses direitos, entre em contato pelo e-mail abaixo.</p>
        </section>

        <section>
          <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-2">5. Cookies e armazenamento local</h3>
          <p className="text-gray-500 dark:text-gray-400">Utilizamos localStorage para armazenar:</p>
          <ul className="list-disc ml-5 mt-2 space-y-1 text-gray-500 dark:text-gray-400">
            <li>Token de autenticação (para manter o login)</li>
            <li>Preferência de tema (claro/escuro)</li>
            <li>Dados de onboarding</li>
          </ul>
          <p className="mt-2 text-gray-500 dark:text-gray-400">Não utilizamos cookies de rastreamento ou publicidade.</p>
        </section>

        <section>
          <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-2">6. Retenção de dados</h3>
          <p className="text-gray-500 dark:text-gray-400">Seus dados são mantidos enquanto sua conta estiver ativa. Ao solicitar exclusão, todos os dados são removidos permanentemente em até 30 dias.</p>
        </section>

        <section>
          <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-2">7. Contato</h3>
          <p className="text-gray-500 dark:text-gray-400">Para dúvidas sobre privacidade ou exercer seus direitos LGPD:</p>
