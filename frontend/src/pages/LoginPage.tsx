          ...
          {tab === 'login' ? (
            ...
            <div className="text-center py-4">
              ...
              <div className="space-y-3">
                <WhatsAppButton message={`Olá! Acabei de me cadastrar no Planejix com o usuário "${regUsername}" e gostaria de solicitar a aprovação do meu acesso.`} />
                <button
                  onClick={() => switchTab('login')}
                  className="w-full px-6 py-2.5 rounded-lg border border-dark-500 text-gray-400 hover:text-white hover:border-dark-400 text-sm font-medium transition-colors"
                >
                  Voltar ao login
                </button>
              </div>
