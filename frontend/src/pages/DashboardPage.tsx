...
import SparklineKpi, { extractSparkData } from '../components/dashboard/SparklineKpi';
...
export default function DashboardPage() {
  ...
  const incomeSparkData = extractSparkData(summary.monthly, 'income');
  const expenseSparkData = extractSparkData(summary.monthly, 'expenses');
  const balanceSparkData = extractSparkData(summary.monthly, 'balance');
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-20 lg:pb-0">
      ...
      {/* Row 1: Area chart + Upcoming payments */}
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <CategoryDonutChart year={year} month={month} />
