  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 pb-20 lg:pb-0 animate-fade-in">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Última atualização: Junho de 2026</p>
      </div>

      <div className="card space-y-5 text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
        <section>
          <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-2">1. Aceitação dos termos</h3>
          <p className="text-gray-500 dark:text-gray-400">Ao criar uma conta ou utilizar o Planejix, você concorda com estes Termos de Uso e com nossa Política de Privacidade. Se não concordar, não utilize o serviço.</p>
        </section>

        <section>
          <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-2">2. Descrição do serviço</h3>
          <p className="text-gray-500 dark:text-gray-400">O Planejix é uma plataforma de gestão financeira pessoal que permite registrar transações, definir metas de orçamento, acompanhar economia e gerar relatórios. O serviço é oferecido mediante assinatura mensal (Planejix Pro).</p>
        </section>

        <section>
          <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-2">3. Conta do usuário</h3>
          <ul className="list-disc ml-5 space-y-1 text-gray-500 dark:text-gray-400">
        ...
        <section>
          ...
          <p className="text-gray-500 dark:text-gray-400">Você concorda em não:</p>
          <ul className="list-disc ml-5 mt-2 space-y-1 text-gray-500 dark:text-gray-400">
        ...
        <section>
          ...
          <p className="text-gray-500 dark:text-gray-400">O Planejix é uma ferramenta de organização financeira pessoal e não constitui consultoria financeira, contábil ou tributária. As decisões financeiras são de exclusiva responsabilidade do usuário. O serviço é fornecido "como está", sem garantias de disponibilidade ininterrupta.</p>
        </section>

        <section>
          <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-2">8. Exclusão de conta</h3>
          <p className="text-gray-500 dark:text-gray-400">Você pode solicitar a exclusão completa da sua conta e dados a qualquer momento. A exclusão é irreversível e todos os dados serão removidos permanentemente.</p>
        </section>

        <section>
          <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-2">9. Alterações nos termos</h3>
          <p className="text-gray-500 dark:text-gray-400">Podemos atualizar estes termos periodicamente. Alterações significativas serão notificadas por e-mail ou aviso no aplicativo. O uso continuado após alterações constitui aceitação dos novos termos.</p>
        </section>

        <section>
          <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-2">10. Contato</h3>
          <p className="text-gray-500 dark:text-gray-400">Para dúvidas sobre estes termos:</p>
