    ...
    <div className="space-y-3">
      <div className="flex flex-wrap gap-3">
        ...
        <button
          ...
          className={`btn-secondary text-sm px-3 py-2 flex items-center gap-1.5 ${showDateRange ? 'border-brand-500 text-brand-400' : ''}`}
          title="Filtrar por período personalizado"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
          </svg>
          <span className="hidden sm:inline">{showDateRange ? 'Período' : 'Período'}</span>
        </button>
