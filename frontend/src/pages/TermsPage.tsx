  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 pb-20 lg:pb-0 animate-fade-in">
      ...
      <div className="card space-y-5 text-sm text-gray-300 leading-relaxed">
        <section>
          <h3 className="text-base font-semibold text-white mb-2">1. Aceitação dos termos</h3>
        ...
        <section>
          <h3 className="text-base font-semibold text-white mb-2">2. Descrição do serviço</h3>
        ...
        <section>
          <h3 className="text-base font-semibold text-white mb-2">3. Conta do usuário</h3>
        ...
        <section>
          <h3 className="text-base font-semibold text-white mb-2">4. Planos e pagamento</h3>
          <ul className="list-disc ml-5 space-y-1 text-gray-400">
        ...
        <section>
          <h3 className="text-base font-semibold text-white mb-2">5. Cancelamento e reembolso</h3>
          <ul className="list-disc ml-5 space-y-1 text-gray-400">
        ...
        <section>
          <h3 className="text-base font-semibold text-white mb-2">6. Uso aceitável</h3>
        ...
        <section>
          <h3 className="text-base font-semibold text-white mb-2">7. Limitação de responsabilidade</h3>
        ...
        <section>
          <h3 className="text-base font-semibold text-white mb-2">8. Exclusão de conta</h3>
        ...
        <section>
          <h3 className="text-base font-semibold text-white mb-2">9. Alterações nos termos</h3>
        ...
        <section>
          <h3 className="text-base font-semibold text-white mb-2">10. Contato</h3>
